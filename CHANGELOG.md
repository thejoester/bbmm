...
### Fixed
- **Soft locks:**
  - Fixed a couple bugs with client scoped settings, as client scoped settings are stored in browser cache they would not persist on browser/computer change and sometimes not sync properly with soft-locks.
...
### Added
- **Import/Export:**
  - Added import and export for lock presets. 
...
### Changed
- **BBMM Journal:**
  - Updated Journal for BBMM to include updated information for Setting Sync, and Lock Manager.

### Fixed
- **Localization:**
  - Fixed broken localization string for "No presets saved yet." text not displaying properly. 

## [1.3.1] - 2026-06-28

### Changed
- **Inclusion/Exclusion Manager:**
  - The **Inclusions** and **Exclusions** section headers now have a distinct background color to improve readability and visually separate the two sections.
  - Section headers are ALSO now collapsible to reduce clutter.
- **Localization:**
  - Updated Brazilian Portuguese (pt-BR) localization. Thank you [Kharmans](https://github.com/Kharmans)!
